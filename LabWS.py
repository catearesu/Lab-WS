# In this lab, you will have to create a Jupyter Notebook where you scrap everytime is executed the updated Billboard Hot 100 songs (URL) 
# and return a dataframe with 100 rows (duh) and the following columns:
# Song
# Artist
# Last Week Rank
# Weeks On Chart
